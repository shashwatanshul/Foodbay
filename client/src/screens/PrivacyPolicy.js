...
const PrivacyPolicy = () => {
  return (
    ...
    >
      ...
      <p>
        When you browse our website at{" "}
        <a href="https://www.foodybay.online">https://www.foodybay.online</a>,
      ...
      <p>
        With your permission, we may send you emails about our website, new
      ...
      <p>
        If after opting in, you change your mind, you may withdraw your consent
        for us to contact you for the continued collection, use, or disclosure
        of your information, at any time, by contacting us at
        <a href="#"> shashwatanshul@gmail.com</a> or by mail at: SHASHWAT SINGH,
      ...
      <p>
        ...
        by the PCI Security Standards Council, a joint effort of brands like
        Visa, MasterCard, American Express, and Discover.
      </p>
      <p>
        For more information, you may also want to read the terms and conditions
        of Razorpay at{" "}
        <a
      ...
      <p>
        ...
        to understand how your personal information will be handled.
      </p>
      <p>
      ...
      <p>
        ...
        of majority in your state or province of residence and have given us
      ...
      <p>
        ...
        changes to this policy, we will notify you here that it has been updated
